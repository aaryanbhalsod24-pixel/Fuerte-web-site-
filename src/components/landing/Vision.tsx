...
//               <h2 className="font-display text-4xl md:text-5xl font-bold tracking-tight text-gradient">Our Vision</h2>
//               <p className="text-muted-foreground text-lg leading-relaxed mb-10">
//                 At Fuerte Developers, we help businesses thrive in the digital world. By combining creativity, strategy, and technology, we deliver solutions that engage your audience and drive measurable growth.
//               </p>
...
//               <img src={visionImage} alt="Team working in modern office" className="w-full h-[400px] object-cover" />
//             </div>
//           </FadeIn>
//         </div>
//       </div>
